...
var SystemError = struct {
	...
	InvalidValidatorFormula       Error `code:"-1012" msg:"invalid validator formula"`
	InvalidValidatorErrorTemplate Error `code:"-1013" msg:"invalid error template"`
	InvalidParams                 Error `code:"-1014" msg:"invalid params"`
}{}
